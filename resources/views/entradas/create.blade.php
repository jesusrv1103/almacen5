...
<div class="pull-left breadcrumb_admin clear_both">
  <div class="pull-left page_title theme_color">
    ...
    <h2 class="">Registrar Entrada de Artículos</h2>
  </div>
  <div class="pull-right">
    <ol class="breadcrumb">
      <li><a style="color: #808080"  href="?c=Inicio">Inicio</a></li>
      <li><a style="color: #808080"  href="?c=localidad">Articulo</a></li>
      <li style="color: #808080"  class="active">Alta de Entrada de Artículo</li>
    </ol>
  </div>
</div>
        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header theme_color" style="margin-top: -5px;">Registrar Entrada de Artículos</h2>
            </div>
            <div class="col-md-4">
          ...
          <div class="porlets-content">
            <form action="{{route('entradas.store')}}" method="post" class="form-horizontal row-border" parsley-validate novalidate>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control mask" name="fechaEntrada" required value=""
